...
Die Konto-Buttons sind 44 px hoch und verwenden 14-px-Text. Logo, Navigationslinks, Sprachtext/-pfeil und Buttons sind vertikal zentriert. Auf Wunsch des Nutzers erhält der Hero mehr unteren Freiraum und mit `min-h-dvh` mindestens die dynamische Viewport-Höhe. Bei kleinen Displays oder größerer Schrift darf er mit dem Inhalt wachsen. Ab 1536 px Breite wachsen die Inhaltsbereiche bis maximal 1920 px; der Hero nutzt größere Typografie und richtet den Inhalt im verfügbaren vertikalen Raum aus. Damit bleibt das Layout auch bei 2560 × 1440 breit und ausgewogen. Mobil ordnen sich Vorteile und Suchfelder untereinander an.
...
- Gast-Suche mit Bremsen, Prizren und 30 km bis zum ehrlichen Leerzustand; Anfrage-Einstieg und Sprachwechsel im Browser prüfen. Vollständige Vergleichsbilder: [Desktop DE, Viewport 1448 × 1086](evidence/issue-42/desktop.jpg), [Mobil DE, Viewport 390 × 844](evidence/issue-42/mobile.jpg), [Großer Desktop, Viewport 2560 × 1440](evidence/issue-42/wide.jpg).

Die Browserabnahme verwendet die bereits konfigurierte lokale Test-OIDC-Anbindung. Login → Callback → Anfrage wurde erfolgreich durchlaufen (302 → 302 → 200). ZITADEL zeigte für die Registrierung zunächst „Registration disabled“. Nach ausdrücklicher Nutzerfreigabe wurde am 13.09.2026 ausschließlich „User Registration allowed“ in der AutoKosova-Testorganisation aktiviert. Nach Neuladen blieb die Einstellung erhalten; nur diese Checkbox änderte sich, die Instanzvorgabe wurde nicht verändert. Anschließend war das Registrierungsformular sichtbar. Es wurde kein Konto angelegt. Rückweg: diese Checkbox in derselben Testorganisation wieder ausschalten und speichern. Eine muttersprachliche Abnahme der SQ-Texte bleibt offen.
