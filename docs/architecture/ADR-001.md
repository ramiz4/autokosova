...
Die UI-Stack-Ergänzung steht in [ADR-002 · Tailwind CSS](ADR-002.md).
...
- `garages`: öffentliche Profildaten, Unternehmensprüfung und Mitgliedschaften.
...
4. Öffentliche Lesemodelle enthalten nur freigegebene Garage-, Leistungs- und Bewertungsfelder. Private Dateien werden erst nach derselben Objektprüfung mit zeitlich enger signierter URL zugänglich.
