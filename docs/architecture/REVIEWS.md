...
Vom öffentlichen Werkstattprofil führt „Bewertung schreiben“ zur kanonischen Route `/garages/:garageId/reviews/new`. „Meine Bewertungen“ unter `/reviews` ist eine private, paginierte Autorenliste mit Detail-/Nachweiszugriff und tatsächlichem Prüfstatus. Die breite Listenansicht durchsucht Werkstattname, Leistung und eigenen Bewertungstext sowie Veröffentlichungsstatus und Einreichungszeit serverseitig über den gesamten eigenen Bestand. Sie liefert die gefilterte Gesamtzahl für die Seitennavigation; private Nachweise, Identitäten und Daten anderer Autoren bleiben dabei ausgeschlossen. Jede Kartenaktion liegt im zugänglichen Drei-Punkte-Menü und führt ausschließlich zu vorhandener Detail-, Nachweis- oder Updatefunktion. Beide Routen existieren in DE/SQ/EN und erhalten ein explizites sicheres Login-Ziel. Vier Kriterien, Mittelwert, Leistung, Besuchsmonat und optionale Marke verwenden denselben gemeinsamen Vertrag in `src/shared/reviews.ts`.
