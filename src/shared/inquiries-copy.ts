const de = {
  ...
  description: 'Deine privat gespeicherten Suchanfragen. Sie sind keine gesendeten Nachrichten, Angebote, Termine oder Aufträge.',
  savedOn: 'Gespeichert am',
  emptyTitle: 'Noch keine gespeicherten Anfragen',
  empty: 'Hier erscheinen nur Anfragen, die du in diesem Konto gespeichert hast. Ein lokaler Browserentwurf gehört nicht dazu.',
  ...
  login: 'Melde dich an, um deine gespeicherten Anfragen zu sehen. Danach kehrst du hierher zurück.',
  expired: 'Deine Sitzung ist abgelaufen oder wurde beendet. Melde dich erneut an, um deine Anfragen zu sehen.',
  ...
  searchHelp: 'Die Suche übernimmt nur Leistung, Orte und Radien. Dein Browserentwurf bleibt unverändert.',
};
export type InquiriesCopyKey = keyof typeof de;
export const inquiriesCopy: Readonly<Record<'de' | 'sq' | 'en', Readonly<Record<InquiriesCopyKey, string>>>> = {
  de,
  sq: {
    title: 'Kërkesat e mia',
    description: 'Kërkesat e tua të kërkimit, të ruajtura privatisht. Ato nuk janë mesazhe të dërguara, oferta, termine apo porosi.',
    savedOn: 'Ruajtur më',
    emptyTitle: 'Ende nuk ka kërkesa të ruajtura',
    empty: 'Këtu shfaqen vetëm kërkesat që i ke ruajtur në këtë llogari. Një draft lokal në shfletues nuk përfshihet.',
    view: 'Shiko kërkesën',
    close: 'Mbyll detajet',
    ...
    searchHelp: 'Kërkimi merr vetëm shërbimin, vendet dhe rrezet. Drafti yt në shfletues mbetet i pandryshuar.',
  },
  en: {
    title: 'My inquiries',
    description: 'Your privately saved search inquiries. These are not sent messages, quotes, appointments or orders.',
    savedOn: 'Saved on',
    emptyTitle: 'No saved inquiries yet',
    empty: 'Only inquiries you saved to this account appear here. A local browser draft is not included.',
    view: 'View inquiry',
    close: 'Close details',
    ...
    searchHelp: 'Search uses only the service, places and radii. Your browser draft stays unchanged.',
  },
};
