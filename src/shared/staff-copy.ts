...
const de = {
  ...
  reviewsIntro: 'Eingereichte Bewertungen prüfen und freigeben oder ablehnen.',
  reportsIntro: 'Gemeldete Inhalte prüfen und entscheiden.',
  appealsIntro: 'Offene Widersprüche unabhängig erneut prüfen.',
  cases: 'Fälle',
  ...
  review_submission: 'Bewertung prüfen und freigeben',
...
const en: Copy = {
  ...
  reviewsIntro: 'Check submitted reviews and approve or reject them.',
  reportsIntro: 'Check reported content and decide.',
  appealsIntro: 'Independently re-review open appeals.',
  cases: 'Cases',
  ...
  review_submission: 'Check and approve review',
...
const sq: Copy = {
  ...
  reviewsIntro: 'Shqyrtoni vlerësimet e dorëzuara dhe miratoni ose refuzoni.',
  reportsIntro: 'Shqyrtoni përmbajtjen e raportuar dhe vendosni.',
  appealsIntro: 'Rishqyrtoni në mënyrë të pavarur ankesat e hapura.',
  cases: 'Rastet',
  ...
  review_submission: 'Shqyrto dhe mirato vlerësimin',
...
const extraLabels: Readonly<Record<string, readonly [string, string, string]>> = {
  ...
  reviewFilter: ['Bewertungen', 'Reviews', 'Vlerësimet'],
  openReview: ['Bewertung prüfen', 'Check review', 'Shqyrto vlerësimin'],
  viewReview: ['Bewertung ansehen', 'View review', 'Shiko vlerësimin'],
  reviewContent: ['Kundenbewertung', 'Customer review', 'Vlerësimi i klientit'],
  reviewEvidence: [
    'Privater Besuchsnachweis',
    'Private visit evidence',
    'Dëshmia private e vizitës',
  ],
  reviewGuidance: [
    'Lies die Bewertung und gleiche den privaten Besuchsnachweis ab. Entscheide anschliessend über Freigabe oder begründete Ablehnung. Eine Freigabe veröffentlicht die Bewertung, nicht den Nachweis.',
    'Read the review and check the private visit evidence. Then approve the review or reject it with a reason. Approval publishes the review, not the evidence.',
    'Lexo vlerësimin dhe kontrollo dëshminë private të vizitës. Pastaj mirato vlerësimin ose refuzoje me arsyetim. Miratimi publikon vlerësimin, jo dëshminë.',
  ],
  reviewDecision: [
    'Bewertung freigeben oder ablehnen',
    'Approve or reject review',
    'Mirato ose refuzo vlerësimin',
  ],
  checklist: ['Besuchsnachweis abgleichen', 'Check visit evidence', 'Kontrollo dëshminë e vizitës'],
  reviewChecksRequired: [
    'Für die Freigabe müssen alle drei Angaben mit dem Besuchsnachweis übereinstimmen. Prüfe und bestätige jeden Punkt einzeln.',
    'Approval requires all three details to match the visit evidence. Check and confirm each item individually.',
    'Miratimi kërkon që të tre të dhënat të përputhen me dëshminë e vizitës. Kontrollo dhe konfirmo secilën pikë veçmas.',
  ],
  confirmReviewRejection: ['Ablehnung bestätigen', 'Confirm rejection', 'Konfirmo refuzimin'],
  garageMatches: [
  ...
  publish_review: ['Bewertung freigeben', 'Approve review', 'Mirato vlerësimin'],
  ...
  effect_publish_review: [
    'Die Bewertung wird öffentlich sichtbar. Text und Sterne bleiben unverändert; der Besuchsnachweis bleibt privat.',
    'The review becomes public. Text and ratings stay unchanged; visit evidence remains private.',
    'Vlerësimi bëhet publik. Teksti dhe yjet mbeten të pandryshuar; dëshmia e vizitës mbetet private.',
  ],
