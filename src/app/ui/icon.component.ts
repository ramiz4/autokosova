...
export class IconComponent {
  ...
  protected readonly paths: Record<IconName, string> = {
    ...
    images: 'M4 5h12v14H4V5Zm4-2h12v14m-14-2 3-3 2 2 2-2 3 3M8 9h.01',
    globe:
      'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm0 0c3 0 5-4.5 5-10S15 2 12 2 7 6.5 7 12s2 10 5 10ZM2 12h20',
    message: 'M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v8Z',
    send: 'm22 2-7 20-4-9-9-4 20-7Zm-11 11 5-5',
    phone:
      'M6.6 2h3l1.5 5-2 1.5a15 15 0 0 0 6.4 6.4l1.5-2 5 1.5v3A4.6 4.6 0 0 1 17.4 22 15.4 15.4 0 0 1 2 6.6 4.6 4.6 0 0 1 6.6 2Z',
    filter: 'M4 5h16M7 12h10m-7 7h4',
    wrench:
      'M14.7 6.3a4 4 0 0 0-5-5L12 3.6 9.6 6 7.3 3.7a4 4 0 0 0 5 5L4 17a2.1 2.1 0 0 0 3 3l8.3-8.3a4 4 0 0 0 5-5L18 9l-3-3 2.3-2.3a4 4 0 0 0-2.6 2.6Z',
    ...
    car: 'M5 17h14l1-6-2-4H6l-2 4 1 6Zm0 0v3m14-3v3M4 12h16M7 14h.01M17 14h.01',
